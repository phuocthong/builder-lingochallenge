<template>
  <div class="q-gutter-md">
    ...
    <div class="row items-center justify-between">
      ...
      <q-chip color="yellow-2" text-color="yellow-8" icon="monetization_on" size="lg">
    ...
    <q-card>
      <q-tabs v-model="activeTaskTab" dense class="text-grey-6" active-color="primary" indicator-color="primary" align="justify">
        ...
        <q-tab-panel name="daily">
          <div class="q-gutter-md">
            <div v-for="task in dailyTasks" :key="task.id">
              <q-card :class="task.completed ? 'bg-green-1 border-green-3' : ''" bordered>
                <q-card-section>
                  <div class="row items-start justify-between q-gutter-md">
                    <div class="col">
                      <div class="flex items-center q-mb-sm">
                        <q-icon :name="getTaskIcon(task.category)" class="q-mr-sm" />
                        <h4 class="text-subtitle1 text-weight-medium q-ma-none" :class="task.completed ? 'text-strike text-grey-6' : ''">
                          {{ task.title }}
                        </h4>
                        <q-icon v-if="task.completed" name="check_circle" color="green" class="q-ml-sm" />
                      </div>
                      
                      <p class="text-body2 text-grey-6 q-mb-sm">{{ task.description }}</p>
                    ...
                    <div class="col-auto">
                      <div v-if="!task.completed" class="q-gutter-xs">
                        <q-btn 
                          ...
                          color="primary"
                          label="+1"
                          @click="updateTaskProgress(task.id, task.progress + 1)"
