  ...
  <q-page class="bg-gradient-to-br from-purple-50 to-blue-50">
    <div class="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
        <div>
          <h2 class="text-3xl font-bold text-gray-900 mb-6">🎯 Sứ mệnh của chúng tôi</h2>
        ...
        <div class="text-center">
          <div class="w-64 h-64 mx-auto bg-gradient-to-r from-purple-400 to-blue-400 rounded-full flex items-center justify-center text-white text-6xl">
            🤖
          </div>
        </div>
      </div>
      ...
      <div class="mb-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <q-card v-for="feature in features" :key="feature.id" class="card-hover">
      ...
      <div class="mb-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <q-card v-for="member in teamMembers" :key="member.id" class="text-center">
            <q-card-section>
              <q-avatar size="80px" class="mb-4">
                <img :src="member.avatar" :alt="member.name" />
              </q-avatar>
              <h3 class="text-xl font-semibold mb-2">{{ member.name }}</h3>
              <p class="text-purple-600 font-medium mb-2">{{ member.role }}</p>
      ...
      <div class="bg-white rounded-2xl p-8 text-center shadow-lg">
        <h2 class="text-3xl font-bold text-gray-900 mb-6">📧 Liên hệ với chúng tôi</h2>
...
const teamMembers = [
  {
    ...
    avatar: "https://via.placeholder.com/150/6366f1/ffffff?text=CEO"
  },
  {
    id: 2,
    name: "Trần Thị B",
    ...
    avatar: "https://via.placeholder.com/150/8b5cf6/ffffff?text=CTO"
  },
  {
    id: 3,
    name: "Lê Văn C",
    ...
    avatar: "https://via.placeholder.com/150/06b6d4/ffffff?text=EDU"
  }
]
</script>
