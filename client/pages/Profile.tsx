          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <Card className="p-6">
              <div className="text-center">
                ...
                {/* User Info */}
                <h2 className="text-2xl font-medium text-gray-900 mb-1">{user.name}</h2>
            ...
            {/* Contact Info */}
            <Card className="p-6">
              <h3 className="text-xl font-medium text-gray-900 mb-6 text-center">Thông tin liên hệ</h3>
              ...
              <TabsContent value="profile" className="space-y-6 mt-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <Card className="p-6 text-center">
                    ...
                    <div className="text-2xl font-bold text-gray-900 mb-1">2,125</div>
                  ...
                  <Card className="p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <div className="text-sm text-gray-600 mb-1">Thời gian trung bình</div>
                  ...
                  <Card className="p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <div className="text-sm text-gray-600 mb-1">Ngày học tập</div>
                        <div className="text-xs text-gray-500">Tổng số ngày</div>
                      </div>
                ...
                {/* Progress Chart */}
                <Card className="p-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-6">Biểu đồ tiến bộ</h3>
