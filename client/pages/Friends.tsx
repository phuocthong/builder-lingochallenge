              ...
              <CardContent>
                {friends.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-xl font-medium text-gray-900 mb-2">Chưa có bạn bè</h3>
                    <p className="text-gray-500 mb-6">Hãy tìm kiếm và kết bạn với người khác!</p>
                        ...
                        <CardContent className="p-6">
                          ...
                          <div className="grid grid-cols-2 gap-2 mb-4 text-xs">
                            <div className="bg-yellow-50 p-2 rounded text-center">
                              ...
                              <div className="font-medium">#{friend.stats.rank}</div>
                            </div>
                            <div className="bg-green-50 p-2 rounded text-center">
                              <Star className="h-3 w-3 text-green-500 mx-auto mb-1" />
                              <div className="font-medium">{friend.stats.totalCorrect}</div>
                            </div>
                          </div>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  ...
                  <Badge variant="secondary">{friendRequests.length} lời mời</Badge>
                </CardTitle>
              </CardHeader>
              <CardContent>
                {friendRequests.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-xl font-medium text-gray-900 mb-2">Không có lời mời nào</h3>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                {searchResults.length > 0 && (
                  <div className="space-y-4">
                    <h3 className="font-medium text-gray-900">Kết quả tìm kiếm ({searchResults.length})</h3>
                          ...
                          <div className="flex items-center space-x-4">
                            ...
                            <div>
                              ...
                              <div className="flex items-center space-x-3 text-xs text-gray-400">
                                ...
                                <span>🔥 {person.stats.accuracy}% chính xác</span>
                              </div>
                            </div>
                          </div>
                ...
                {/* Quick Suggestions */}
                <div>
                  <h3 className="font-medium text-gray-900 mb-3">💡 Gợi ý kết bạn</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-4 border border-gray-200 rounded-lg bg-gradient-to-r from-purple-50 to-blue-50">
                      <div className="flex items-center space-x-3 mb-3">
                        <Crown className="h-8 w-8 text-yellow-500" />
                        <div>
                          <h4 className="font-medium">Kết bạn với Top Players</h4>
                          <p className="text-sm text-gray-600">Học hỏi từ những người giỏi nhất</p>
                        </div>
                      </div>
                    ...
                    <div className="p-4 border border-gray-200 rounded-lg bg-gradient-to-r from-green-50 to-blue-50">
                      <div className="flex items-center space-x-3 mb-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">Mời bạn bè tham gia EnglishBot</p>
                        </div>
                      </div>
                      <Button size="sm" variant="outline" className="w-full">
                        Gửi lời mời
