  ...
  <q-page class="bg-gradient-to-br from-purple-50 to-blue-50">
    <div class="q-pa-md">
      <div class="text-center q-mb-lg">
        ...
        <div class="text-grey-6">Thử thách bản thân và cạnh tranh với bạn bè</div>
      </div>
      ...
      <div v-if="!authStore.isLoggedIn" class="text-center q-pa-xl">
        <q-card class="q-pa-lg">
          ...
          <div class="text-grey-6 q-mt-sm">Cạnh tranh với người chơi khác và nâng cao kỹ năng</div>
        </q-card>
      </div>
        ...
        <div class="row q-gutter-md q-mb-lg">
          <div class="col-12 col-md-6">
            <q-card class="challenge-card text-center q-pa-lg">
              ...
              <div class="text-grey-6 q-mb-md">Thách đấu trực tiếp với một người chơi khác</div>
          ...
          <div class="col-12 col-md-6">
            <q-card class="challenge-card text-center q-pa-lg">
              ...
              <div class="text-grey-6 q-mb-md">Tham gia phòng thách đấu với nhiều người</div>
            ...
            <q-list>
              <q-item v-for="challenge in recentChallenges" :key="challenge.id">
                <q-item-section avatar>
                  <q-avatar :color="challenge.result === 'win' ? 'green' : challenge.result === 'lose' ? 'red' : 'grey'" text-color="white">
                    <q-icon :name="challenge.result === 'win' ? 'emoji_events' : challenge.result === 'lose' ? 'close' : 'remove'" />
                  </q-avatar>
                </q-item-section>
                
                <q-item-section>
                  <q-item-label>{{ challenge.opponent }}</q-item-label>
                  <q-item-label caption>{{ challenge.mode }} - {{ challenge.date }}</q-item-label>
                </q-item-section>
                ...
                <q-item-section side>
                  <div class="text-right">
                    ...
                    <q-chip 
                      :color="challenge.result === 'win' ? 'green' : challenge.result === 'lose' ? 'red' : 'grey'"
                      text-color="white"
                      size="sm"
                    >
            ...
            <q-list>
              <q-item v-for="(player, index) in leaderboard" :key="player.id">
                ...
                <q-item-section>
                  ...
                  <q-item-label caption>{{ player.wins }} thắng / {{ player.losses }} thua</q-item-label>
                </q-item-section>

                <q-item-section side>
                  <div class="text-right">
                    <div class="text-weight-bold text-primary">{{ player.rating }}</div>
